...
exports.Wrapper = exports.withFormsy = exports.validationRules = exports.defaultProps = exports.propTypes = exports.addValidationRule = undefined;
...
var Formsy = function (_React$Component) {
  ...
  function Formsy(props) {
    ...
    _this.validate = function (component) {
      ...
      return _this.runValidation(component).then(function (validation) {
        if (!validation) {
          return;
        }
        component.setState({
    ...
    _this.validateForm = function () {
      ...
      return Promise.all(_this.inputs.map(function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(component) {
          var validation;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return _this.runValidation(component);
...
exports.defaultProps = _Wrapper.defaultProps;
